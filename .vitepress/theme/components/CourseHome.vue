...
const BLOCKS = [
  ...
  },
  {
    ...
    items: [
      { id: '07', t: 'Багатоагентний градієнт політики' },
      { id: '08', t: 'Багатоагентне навчання для роїв БПЛА' },
      { id: '09', t: 'Практика багатоагентного навчання' },
      { id: '10', t: 'Конкретні задачі роїв' }
    ]
  },
  {
    code: 'D',
    ...
    items: [
      { id: '11', t: 'Безпека та робастність роїв БПЛА' },
      { id: '12', t: 'Реалізація та інструменти' }
    ]
  }
]
...
<template>
  ...
  <div class="uk-facts">
    <div class="uk-fact"><b>12</b><span>модулів</span></div>
